...
public class SoundManagerUI : EditorWindow
{
    ...
    private void CreateGUI()
    {
        ...
        // Music Field
        MusicObjectField = root.Q<ObjectField>("MusicObjectField");
        MusicObjectField.objectType = typeof(AudioClip);
        MusicObjectField.value = _SoundObject.Music;
        MusicObjectField.RegisterValueChangedCallback((e) =>
        {
            _SoundObject.Music = (AudioClip)e.newValue;
