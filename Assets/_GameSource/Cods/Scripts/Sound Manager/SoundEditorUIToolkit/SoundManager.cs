...
namespace As_Star
{
    public class SoundManager : MonoBehaviour
    {
        ...
        [SerializeField] AudioSource MusicObj;
        ...
        private void Initialize()
        {
            ...
            if (Sounds.Music && MusicObj != null)
            {
                MusicObj.clip = Sounds.Music;
                MusicObj.playOnAwake = true;
                MusicObj.Play();
        ...
        {
            MusicObj.gameObject.SetActive(CanPlayMusic);
        }
